...
import Spline from "@splinetool/react-spline"; // Uncomment if using Spline for 3D models
import { div } from "framer-motion/client";

//The custom Character to accept isHovering3D as a prop
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            >
              ...
              <div className="w-20 h-20 bg-gray-800/50 rounded-md flex items-center justify-center mb-2">
                <img src="public\images\VIKI.png" alt="EVA-Img" />
              </div>
              {/* Star rating */}
              <div className="flex">
                {[...Array(3)].map((_, index) => (
        ...
        >
          <AnimatePresence mode="wait">
            {selectedAvatar === "VIKI" ? (
              ...
              >
                <Spline scene="https://prod.spline.design/UQXvgxVqki6UmuNR/scene.splinecode" />
              </motion.div>
            ) : (
              <motion.div
                key="EVA"
                ...
                transition={{ duration: 0.5 }}
              >
                <Spline scene="https://prod.spline.design/rQ6Dl2jgGqwDUxTv/scene.splinecode" />
              </motion.div>
            )}
          </AnimatePresence>
        </div>
