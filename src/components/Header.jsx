    ...
    <header className="py-1 px-7 flex justify-between items-center sticky top-0 z-50 w-full border-b-[0.3px] border-[#babaff] bg-black">
      ...
      <div className="flex lg:gap-14 gap-4 items-center">
        ...
        <div className="hidden md:flex items-center gap-5">
          <button className="h-8 px-6 bg-gradient-to-r from-purple-500 to-indigo-600 rounded-lg font-medium text-nowrap hover:opacity-70 trannsition-all duration-300">
            Play Now
          </button>
          <button className="h-8 px-6 bg-gradient-to-r from-gray-500 to-gray-400 rounded-lg font-medium text-nowrap hover:opacity-70 trannsition-all duration-300">
            Play Now
          </button>
        </div>
      </div>
